import cv2
image_1 = cv2.imread("Thomas_Edison.jpg")
image_2 = cv2.imread("Graham_Bell.jpg")
...
# cv2.waitKey()
cv2.imwrite("death_Thomas_Edison.jpg",grayscale_image_1)
cv2.imwrite("death_Graham_Bell.jpg",grayscale_image_2)